...
static void battery_update_proc(Layer *layer, GContext *ctx) {
  ...
  int width = (int)(float)(((float)s_battery_level / 100.0F) * 14.0F);
...
static void main_window_load(Window *window){
  // Create canvas Layer
  s_diamond_layer = layer_create(GRect(22, 28, 60, 60));
  ...
  s_time_layer = text_layer_create(GRect(5, 118, 150, 50));
  text_layer_set_background_color(s_time_layer, GColorClear);
  text_layer_set_text_color(s_time_layer, GColorBlack);
  text_layer_set_text(s_time_layer, "00:00");
  
  s_time_sec_layer = text_layer_create(GRect(107, 128, 150, 50));
  ...
  s_am_pm_layer = text_layer_create(GRect(16,98,20,15));
  ...
  s_date_layer = text_layer_create(GRect(16,-8,70,15));
  ...
  // Create GFont
  s_time_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_SEVEN_SEG_30));
  s_time_mid_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_SEVEN_SEG_20));
  s_time_small_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_SEVEN_SEG_15));
  ...
  text_layer_set_font(s_date_layer, s_letter_font);
  ...
  s_hands_layer = layer_create(GRect(12, 18, 67, 67));
  ...
  s_battery_layer = layer_create(GRect(122, 21, 15, 2));
